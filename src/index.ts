...
// --- Endpoint para Consultar Estado de una Orden de Domiciliación ---
app.post('/domiciliacion/status/:id', handleGetOrderStatus)
...
const server = serve(
	...
	(info) => {
		...
		console.log('POST /domiciliacion/status/:id:')
